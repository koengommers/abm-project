...
model_params = {
    'grass_clusters': UserSettableParameter('slider', 'Grass clusters', 8, 1, 50),
    'grass_cluster_size': UserSettableParameter('slider', 'Grass cluster size', 60, 10, 1000, 10),
    ...
    'prey_death_chance': UserSettableParameter('slider', 'Prey death chance', 0, 0.0, 1.0, 0.01),
    'prey_reproduction_min': UserSettableParameter('slider', 'Prey reproduction minimum', 20, 0, 100),
    'prey_food_search_max': UserSettableParameter('slider', 'Prey food search maximum', 40, 0, 100),
    'prey_sight': UserSettableParameter('slider', 'Prey sight', 40, 0, 100),
    ...
    'predator_gain_from_food': UserSettableParameter('slider', 'Predator gain from food', 20, 1, 50),
    'predator_reproduction_chance': UserSettableParameter('slider', 'Predator reproduction chance', 0.05, 0, 1.0, 0.01),
    'predator_death_chance': UserSettableParameter('slider', 'Predator death chance', 0.02, 0.0, 1.0, 0.01),
    ...
    'predator_sight': UserSettableParameter('slider', 'Predator sight', 40, 0, 100),
